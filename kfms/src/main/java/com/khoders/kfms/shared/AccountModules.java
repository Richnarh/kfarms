 ...
 * @author khoders
 */
@Named(value = "accountModule")
@SessionScoped
public class AccountModules implements Serializable{

    private static List<SelectItem> accountTypeList = new LinkedList<>();
    ...
    private void init()
    {
        ...
        SelectItemGroup equityGroup = new SelectItemGroup(AccountCategory.REVENUE.getLabel());
    ...
    public static List<SelectItem> getAccountTypeList() {
